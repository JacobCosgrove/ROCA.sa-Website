...
<head>
  ...
  <title>View Job | VetBosSel</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>VetBosSel</b></span>
    </a>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2020 <a href="http://www.vetbossel.in">VetBosSel</a>.</strong> All rights
    reserved.
    </div>
  </footer>
